...
$(document).ready(function() {
	$('.header-main__burger').click(function(event) {
		$('.header-main__burger').toggleClass('active');
		$('.header-main__menu').toggleClass('activeMenu');
		$('.header-main__list').toggleClass('activeList');
